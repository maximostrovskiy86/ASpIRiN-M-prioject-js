!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? (exports.Pagination = e())
    : ((t.tui = t.tui || {}), (t.tui.Pagination = e()));
})(window, function () {
  return (function (t) {
    var e = {};
    function n(i) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        for (s = 1, r = arguments.length; s < r; s += 1)
          for (i in (n = arguments[s])) o.call(n, i) && (t[i] = n[i]);
        return t;
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        for (r = e.length, s = n; n >= 0 && s < r; s += 1) if (e[s] === t) return s;
        return -1;
      };
    },
    function (t, e, n) {
      ...
      var i = n(13),
        ...
        p = s({
          init: function (t, e) {
            (this._options = r({}, c, e)),
              (this._currentPage = 0),
              (this._view = new a(t, this._options, u.bind(this._onClickHandler, this))),
              this._paginate(),
              this._options.usageStatistics && u.sendHostName();
          },
          ...
          _makeViewData: function (t) {
            var e = {},
              ...
              s = this._getPageIndex(n),
              r = this._getEdge(t);
            return (
              (e.leftPageNumber = r.left),
              (e.rightPageNumber = r.right),
              (e.prevMore = i > 1),
              (e.nextMore = i < s),
              (e.page = t),
          ...
          _getEdge: function (t) {
            var e,
              ...
              i,
              s = this._getLastPage(),
              r = this._options.visiblePages,
              o = this._getPageIndex(t);
            return (
              this._options.centerAlign
                ? ((i = Math.floor(r / 2)),
                  (n = (e = Math.max(t - i, 1)) + r - 1) > s &&
                    ((e = Math.max(s - r + 1, 1)), (n = s)))
                : ((e = (o - 1) * r + 1), (n = o * r), (n = Math.min(n, s))),
              { left: e, right: n }
            );
          },
          ...
          reset: function (t) {
            o(t) && (t = this._options.totalItems),
      ...
      (l.mixin = function (t) {
        ...
        (l.prototype.once = function (t, e, n) {
          ...
          this.on(
            t,
            function s() {
              e.apply(n, arguments), i.off(t, s, n);
            },
            n,
          );
        }),
        ...
        (l.prototype._matchHandlerAndContext = function (t, e) {
          ...
          return function (i) {
            var s = t === i.handler,
              r = e === i.context,
              o = s && r;
            return o && n._forgetContext(i.context), o;
          };
        }),
          ...
          _appendPages: function (t) {
            ...
            for (n = i; n <= s; n += 1)
              n === t.page
                ...
                n !== i || t.prevMore || u(e, this._firstItemClassName),
                n !== s || t.nextMore || u(e, this._lastItemClassName),
                this._getContainerElement().appendChild(e);
          },
            ...
            o(
              ...
              function (e) {
                var n,
                  i,
                  s = r(e);
                a(e), (i = this._getButtonType(s)) || (n = this._getPageNumber(s)), t(i, n);
              },
              this,
            );
          },
        ...
        'addEventListener' in t
          ...
          (function (t, e, n, i) {
            var o = r(t, e),
              a = !1;
            s(o, function (t) {
              return t.handler !== n || ((a = !0), !1);
            }),
              a || o.push({ handler: n, wrappedHandler: i });
          })(t, e, n, o);
      }
    ...
    function (t, e, n) {
        ...
        v = {
          if: function (t, e, n) {
            var i = (function (t, e) {
              ...
              o = '';
            return (
              s(i.exps, function (t, e) {
                return (r = b(t, n)) && (o = P(i.sourcesInsideIf[e], n)), !r;
              }),
              o
            );
          },
          each: function (t, e, n) {
            ...
            return (
              s(i, function (t, i) {
                (u[o] = i), (u['@this'] = t), a(n, u), (c += P(e.slice(), n));
              }),
              c
            );
          },
          ...
          3 === 'a'.split(/a/).length
            ...
            : function (t, e) {
                ...
                for (e.global || (e = new RegExp(e, 'g')), n = e.exec(t); null !== n; )
                  (i = n.index), s.push(t.slice(r, i)), (r = i + n[0].length), (n = e.exec(t));
      ...
      function x(t, e) {
        ...
        return (
          'true' === t
            ...
            ? (i = t.replace(g, ''))
            : c.test(t)
            ? (i = x((n = t.split(p))[0], e)[x(n[1], e)])
            : l.test(t)
            ? (i = x((n = t.split(f))[0], e)[n[1]])
            : _.test(t) && (i = parseFloat(t)),
          i
        );
      }
      function y(t, e, n) {
        for (var i, s, r, a, u = v[t], c = 1, p = 0 + d, l = e[p]; c && o(l); )
          0 === l.indexOf(t) ? (c += 1) : 0 === l.indexOf('/' + t) && ((c -= 1), (i = p)),
            (l = e[(p += d)]);
        if (c) throw Error(t + ' needs {{/' + t + '}} expression.');
        return (
          (e[0] = u(
            e[0].split(' ').slice(1),
            ((s = 0), (r = i), (a = e.splice(s + 1, r - s)).pop(), a),
            n,
          )),
          e
        );
      ...
      function P(t, e) {
        for (var n, i, s, r = 1, a = t[r]; o(a); )
          (i = (n = a.split(' '))[0]),
            v[i] ? ((s = y(i, t.splice(r, t.length - r), e)), (t = t.concat(s))) : (t[r] = b(n, e)),
            (a = t[(r += d)]);
        return t.join('');
      }
      t.exports = function (t, e) {
